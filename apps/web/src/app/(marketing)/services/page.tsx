...
export const metadata: Metadata = {
  ...
  description:
    'Make your website accessible to everyone — audits from ₹14,999, widget from ₹999/mo, remediation from ₹49,999. Built for people with disabilities and Indian compliance.',
  openGraph: {
    title: 'Services & Pricing | AccessShield India',
    description:
      'Accessibility audits, widget, remediation, and monitoring — so people with disabilities can use your site, with RPwD, IS 17802, GIGW, and SEBI proof.',
    type: 'website',
  },
  alternates: {
