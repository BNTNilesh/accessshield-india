  ...
  Te = () => {
    ...
    return {
      ...
      classGroups: {
        ...
        grow: [{ grow: I() }],
        shrink: [{ shrink: I() }],
        order: [{ order: ['first', 'last', 'none', P, l] }],
        'grid-cols': [{ 'grid-cols': [j] }],
        'col-start-end': [{ col: ['auto', { span: ['full', P, l] }, l] }],
        'col-start': [{ 'col-start': N() }],
        'col-end': [{ 'col-end': N() }],
        'grid-rows': [{ 'grid-rows': [j] }],
        'row-start-end': [{ row: ['auto', { span: [P, l] }, l] }],
        ...
        'max-w': [
          { 'max-w': [l, r, 'none', 'full', 'min', 'max', 'fit', 'prose', { screen: [A] }, A] },
        ],
        ...
        leading: [{ leading: ['none', 'tight', 'snug', 'normal', 'relaxed', 'loose', C, l] }],
...
export { ne as a, We as c, Ve as f };
