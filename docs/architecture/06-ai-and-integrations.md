...
| ----------------------- | ----------- | ------------------- | ------------------------------------------------------------------------------------------------ |
| **Supabase**            | Implemented | web, api            | `NEXT_PUBLIC_SUPABASE_*`, `SUPABASE_*` — Auth, Realtime, hosted Postgres option                  |
| **Anthropic**           | Implemented | ai-service          | `ANTHROPIC_API_KEY`                                                                              |
| **Sanity**              | Implemented | web (blog)          | `NEXT_PUBLIC_SANITY_PROJECT_ID`, `NEXT_PUBLIC_SANITY_DATASET`                                    |
| **AWS S3**              | Implemented | api, mobile-scanner | `S3_BUCKET_NAME`, `AWS_*` — screenshots, reports, APKs, documents                                |
